...
| `clipboardWrite`                             | `document.execCommand('copy')` in a content script outside a user gesture — the context-menu copy on a non-secure page, where `navigator.clipboard` is undefined                                                                                            |
